...
-- --- FUNÇÕES DE TELEPORTE (ATUALIZADAS) ---
...
local function AbaTeleport()
    LimparContent()
    -- Coordenadas baseadas nas suas prints:
    criarTp("1sx-FORÇA", Color3.fromRGB(200, 50, 50), Vector3.new(749.21, 218.03, 3639.50)) -- Imagem 1
    criarTp("1sx-CHAKRA", Color3.fromRGB(50, 50, 200), Vector3.new(-900.48, 550.06, 4236.71)) -- Imagem 2
    criarTp("1sx-DURAB.", Color3.fromRGB(50, 200, 50), Vector3.new(-3872.25, 565.99, 1431.89)) -- Imagem 3
end
